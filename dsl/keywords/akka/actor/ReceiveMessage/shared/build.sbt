...
libraryDependencies += "com.thoughtworks.dsl" %%% "dsl" % "1.5.4"

addCompilerPlugin("com.thoughtworks.dsl" %% "compilerplugins-bangnotation" % "1.5.4")

libraryDependencies += "com.thoughtworks.dsl" %% "compilerplugins-bangnotation" % "1.5.4" % Optional // For Scaladoc

addCompilerPlugin("com.thoughtworks.dsl" %% "compilerplugins-reseteverywhere" % "1.5.4")

libraryDependencies += "com.thoughtworks.dsl" %% "compilerplugins-reseteverywhere" % "1.5.4" % Optional // For Scaladoc
